...
class PostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poster" do
    assert_difference('Poster.count') do
      post posters_url, params: { poster: { author: @poster.author, first_name: @poster.first_name, last_name: @poster.last_name, picture: @poster.picture, title: @poster.title } }
    end
  ...
  test "should update poster" do
    patch poster_url(@poster), params: { poster: { author: @poster.author, first_name: @poster.first_name, last_name: @poster.last_name, picture: @poster.picture, title: @poster.title } }
